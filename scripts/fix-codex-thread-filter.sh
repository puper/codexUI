...
# when running with a different external provider, and vice versa.
#
...
Patch Codex.app to show threads from ALL model providers regardless of the
...
echo "Threads from openai and any other provider"
